...
\begin{document}
	...
	O tempo total de execução será medido utilizando a função \texttt{DESCREVER FUNCAO AQUI...} para a versão sequencial, e \texttt{DESCREVER FUNCAO AQUI....} para a versão CUDA.
